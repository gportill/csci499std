...
def create_model(year):
    ...
    plt.savefig("../figures/model_figures/gbr/no_feature_selection/gbr_" + str(year) + "_cv_no_feature_selection.png")
    plt.clf()
    ...
    # plt.show()
    plt.savefig("../figures/model_figures/gbr/feature_selection/gbr_" + str(year) + "_feature_selection_plot.png")
    plt.clf()
    ...
    plt.savefig("../figures/model_figures/gbr/feature_selection/gbr_" + str(year) + "_no_cv_only_top_features.png")
    plt.clf()
