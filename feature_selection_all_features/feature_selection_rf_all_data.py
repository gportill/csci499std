...
def create_model(year):
    ...
    # plt.show()            plt.show()
    plt.savefig("./all_feature_figures/rf/rf_" + str(year) + "_cv_no_feature_selection.png")
    plt.clf()
    ...
    # plt.show()            plt.show()
    plt.savefig("./all_feature_figures/rf/rf_" + str(year) + "_feature_selection_plot.png")
    plt.clf()
    ...
    # plt.show()
    plt.savefig("./all_feature_figures/rf/rf_" + str(year) + "_no_cv_only_top_features.png")
    plt.clf()
