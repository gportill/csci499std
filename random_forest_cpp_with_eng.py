...
def create_model(year):
    ...
    # try changing target
    # lm = RandomForestRegressor(bootstrap=True, max_depth=12, max_features='auto',
    #                            min_samples_leaf=4, min_samples_split=5,
    #                            n_estimators=45, random_state=5)
    ...
    lm = RandomForestRegressor(n_estimators=100, random_state=5)  # yr 2008: 425, 5000 = r2 of 0.131, 8000
