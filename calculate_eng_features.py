...
# for a particular year
    # for each row of STD data: => county i (for each row, we will look at county i's neighbors in migration data)
        # store the neighbor's neighbors in a list (take this from
        # expected_infected = 0
        # for each neighbor j in the list:
            ...
            # add that calculation to the expected_infected variable

# you HAVE TO CHANGE THE NEIGHBORS LIST / ADJACENCY FUNCTION TO FIPS
