...
def create_model(year):
    ...
    full_df['cases_raw_t0'] = full_df['cases_raw_t0'].astype(float)
    full_df['cases_raw_t1'] = full_df['cases_raw_t1'].astype(float)
    full_df['cases_raw_t2'] = full_df['cases_raw_t2'].astype(float)
    full_df['cases_raw_t3'] = full_df['cases_raw_t3'].astype(float)
    full_df['cases_raw_t4'] = full_df['cases_raw_t4'].astype(float)

    # diff_cases_t0_t4
    full_df['diff_cases_t0_t4'] = full_df['cases_raw_t4'] - full_df['cases_raw_t0']
    # diff_cases_t0_t1
    full_df['diff_cases_t0_t1'] = full_df['cases_raw_t1'] - full_df['cases_raw_t0']
    # diff_cases_t1_t2
    full_df['diff_cases_t1_t2'] = full_df['cases_raw_t2'] - full_df['cases_raw_t1']
    # diff_cases_t2_t3
    full_df['diff_cases_t2_t3'] = full_df['cases_raw_t3'] - full_df['cases_raw_t2']
    # diff_cases_t3_t4
    full_df['diff_cases_t3_t4'] = full_df['cases_raw_t4'] - full_df['cases_raw_t3']
    # print(full_df.head())
    ...
    print("r2: " + str(r2))  # r2: 0.9737827960028064
