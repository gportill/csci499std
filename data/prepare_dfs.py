...
if os.path.isfile('./pickles/save_std_dfs.p') and os.path.isfile('./pickles/save_adj_fips_dict.p') and \
        os.path.isfile('./pickles/save_census_dfs.p') and os.path.isfile('./pickles/save_migration_dfs.p') and \
        os.path.isfile('./pickles/save_fips_to_county_dict.p'):
    print("pickles already exist")
else:
    print("regenerating pickles")

    # reads all raw data into data frames and pickles them for future use
    ...
    pickle.dump(std_dfs, open("./pickles/save_std_dfs.p", "wb"))
    pickle.dump(adj_fips_dict, open("./pickles/save_adj_fips_dict.p", "wb"))
    pickle.dump(census_dfs, open("./pickles/save_census_dfs.p", "wb"))
    pickle.dump(migration_dfs, open("./pickles/save_migration_dfs.p", "wb"))
    pickle.dump(fips_to_county_dict, open("./pickles/save_fips_to_county_dict.p", "wb"))

std_dfs = pickle.load(open("./pickles/save_std_dfs.p", "rb"))
adj_fips_dict = pickle.load(open("./pickles/save_adj_fips_dict.p", "rb"))
census_dfs = pickle.load(open("./pickles/save_census_dfs.p", "rb"))
migration_dfs = pickle.load(open("./pickles/save_migration_dfs.p", "rb"))
fips_to_county_dict = pickle.load(open("./pickles/save_fips_to_county_dict.p", "rb"))
...
file_name = "full_features_mig_no_nan_v.xlsx"
path = directory + file_name
full_df_no_na.to_excel(path, na_rep="nan", index=False)
...
directory = "./prepared_data/"
file_name = 'full_features_by_year.xlsx'
path = directory + file_name
